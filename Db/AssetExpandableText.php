<?php
/**
 * InstaPress Cms_Db_AssetExpandableText
 * LICENSE
 * @author		Pramod Thakur
 * @package		InstaPress
 * @copyright	Copyright (c) Citizen Media Pvt. Ltd. (http://www.instablogs.com/)
 */
class Cms_Db_AssetExpandableText extends Cms_Db_Abstract
{
	protected $_mainTable = "cms_asset_expandable_text";
	protected $_clauseColumnNames = array( 'assetId', 'xElementId', 'xElementValue', 'xGroupId', 'clientId', 'createdUserId', 'createdTime' );
	protected $_sortColumnNames = array("assetId", "clientId","xGroupId","xElementId","createdUserId","createdTime");
